...
class Admin_Categories extends Admin_Controller
{
	...
	public function index()
	{
		...
		$total_rows = $this->awards_categories_m->count_all();
		$pagination = create_pagination('admin/awards/categories/index', $total_rows);
			
		// Using this data, get the relevant results
		$categories = $this->awards_categories_m->order_by('title')->limit($pagination['limit'])->get_all();
	...
	public function create()
	{
		...
		{
			$this->awards_categories_m->insert($_POST)
			...
			redirect('admin/awards/categories');
		}
	...
	{	
		// Get the category
		$category = $this->awards_categories_m->get($id);
		
		// ID specified?
		$category or redirect('admin/awards/categories/index');
		
		// Validate the results
		if ($this->form_validation->run())
		{		
			$this->awards_categories_m->update($id, $_POST)
			...
			redirect('admin/awards/categories/index');
		}
	...
	{	
		...
		if(!empty($id_array))
		{
			...
			{
				if($this->awards_categories_m->delete($id))
				{
					$deleted++;
				}
				else
	...
	{
		if ($this->awards_categories_m->check_title($title))
		{
	...
	public function create_ajax()
	{
		...
		if ($this->form_validation->run())
		{
			$id = $this->awards_categories_m->insert_ajax($_POST);
